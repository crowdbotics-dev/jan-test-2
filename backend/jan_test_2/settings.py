"""
Django settings for jan_test_2 project.
...
WSGI_APPLICATION = 'jan_test_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jan_test_2 API",
    "DESCRIPTION": "API documentation for jan_test_2 App",
    "VERSION": "v1",
}
